    ...
    public static class HelloConversationController implements TUIConversationControllerListener {
        ...
        public CharSequence getConversationDisplayString(IBaseInfo baseInfo) {
            if (baseInfo instanceof HelloMessageInfo) {
                return EarthAngelApp.instance.getString(R.string.welcome_tip);
            }
            return null;
        }
    }
    ...
    public static class CustomMessageDraw implements IOnCustomMessageDrawListener {
        ...
        public void onDraw(ICustomMessageViewGroup parent, MessageInfo info, int position) {
            ...
            try {
                ...
                Log.e("","invalid json: " + new String(elem.getData()) + " " + e.getMessage());
            ...
            if (data == null) {
             //   DemoLog.e(TAG, "No Custom Data: " + new String(elem.getData()));
                Log.e("", "No Custom Data: " + new String(elem.getData()));
                    ...
                    || (data.version == TUIKitConstants.JSON_VERSION_4 )||data.version == TUIKitConstants.JSON_VERSION_UNKNOWN) {
