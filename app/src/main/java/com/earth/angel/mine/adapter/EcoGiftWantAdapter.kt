    ...
    override fun convert(holder: BaseViewHolder, item: GiftEntity) {
        ...
        item.valuation.let {
            if (it == 0.0) {
                ...
                tvValueNum?.visibility = View.INVISIBLE
                llValue?.visibility = View.INVISIBLE
            } else {
        ...
        lydelete?.visibility=View.INVISIBLE
