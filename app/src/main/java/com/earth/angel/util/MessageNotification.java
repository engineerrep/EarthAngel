...
import com.earth.angel.chat.IBaseLiveListener;
import com.earth.angel.chat.TUIKitLiveListenerManager;
import com.earth.angel.main.EarthAngelMainActivity;
...
public class MessageNotification {
    ...
    private void createNotificationChannel(boolean isDialing) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (isDialing) {
                channel = new NotificationChannel(NOTIFICATION_CHANNEL_CALL, BaseApplication.instance.getString(R.string.call_notification), NotificationManager.IMPORTANCE_HIGH);
                channel.setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_RINGTONE), null);
                channel.setDescription(BaseApplication.instance.getString(R.string.background_tip));
                channel.setVibrationPattern(new long[]{0, 1000, 1000, 1000, 1000});
            } else {
                channel = new NotificationChannel(NOTIFICATION_CHANNEL_COMMON, BaseApplication.instance.getString(R.string.new_msg_notification), NotificationManager.IMPORTANCE_HIGH);
                channel.setDescription(BaseApplication.instance.getString(R.string.background_tip));
            }
    ...
    public void notify(V2TIMMessage msg) {
      ...
      //  DemoLog.e(TAG, "isDialing: " + isDialing);
        ...
        String tickerStr = BaseApplication.instance.getString(R.string.new_msg);
        ...
        if (isDialing) {
            launch = new Intent(mContext, EarthAngelMainActivity.class);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
                ...
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        builder.setContentText(BaseApplication.instance.getString(R.string.call_nos));
