package com.earth.libbase.network.img;
...
public class Signer {
  ...
  public void sign(HttpUriRequest request, Credentials credentials) throws Exception {
    ...
    String signature = Utils.encodeHexString(Utils.hmacSHA256(signingKey, stringToSign));
  ...
  private String hashedCanonicalRequestV4(HttpUriRequest request, MetaData meta) throws Exception {
    ...
    String sb=new String(body);
    Log.e("TAG", "hashedCanonicalRequestV4:12 "+sb);
    ...
    s.add(bean);
    NameValuePair bean1= new NameValuePair() {
      @Override
      public String getName() {
        return "Version";
      }
  ...
  private String normQuery(List<NameValuePair> params) {
    ...
    String query = URLEncodedUtils.format(params, String.valueOf(Consts.UTF_8));
