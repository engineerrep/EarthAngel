...
public class OssService {
    ...
    public void setInterface(OssInterface ossInterface) {
    ...
    public void asyncPutImage(String filetype, String localFile) {
        final long upload_start = System.currentTimeMillis();
        OSSLog.logDebug("upload start");
        String objekt = "android_earth/" + upload_start;
        ...
        PutObjectRequest put = new PutObjectRequest(mBucket, objekt + filetype, localFile);
        ...
        OSSAsyncTask task = mOss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest putrequest, PutObjectResult result) {
                if (ossInterface != null) {
                    ossInterface.onBankString(localFile, Config.IMAGE_HEAD + putrequest.getObjectKey());
                }
                Log.d("PutObject", "UploadSuccess");
                Log.d("IMAGEPATH", Config.IMAGE_HEAD + putrequest.getObjectKey());
