...
public class BaseCustomPopupWindow {
    ...
    public BaseCustomPopupWindow(Builder builder) {
     ...
     * popup 全屏
     */
    public void fullWindow(Boolean flag) {
        mPopupWindow.setClippingEnabled(flag);
     ...
     * @return
     */
    public BaseCustomPopupWindow showAtLocation(View view, int gravity, int x, int y) {
     ...
     * @return
     */
    public BaseCustomPopupWindow showAsDropDown(View anchor, int xoff, int yoff,int gravity) {
        if (mPopupWindow != null) {
    ...
    public static class Builder {
        ...
        public BaseCustomPopupWindow build() {
            return new BaseCustomPopupWindow(this);
        }
    }
}
