...
class CustomLayoutView @JvmOverloads constructor(
    ...
    private fun initView() {
        val view =
            LayoutInflater.from(mContext).inflate(R.layout.layout_custom_textview, this)
        val layoutParams = LayoutParams(
            LayoutParams.MATCH_PARENT,
            LayoutParams.WRAP_CONTENT
        )
        view.layoutParams = layoutParams
        tvContent = findViewById(R.id.CategoryContent)
        tvTitle = findViewById(R.id.CategoryTV)
        mCategoryIV= findViewById(R.id.CategoryIV)
    }
