...
class HomePopMoreUtil {

    private var contentView: View? = null
    fun showPopupWindow(context: Context?, v: View, onItemClick: HomeOnItemClick) {
        contentView =
            LayoutInflater.from(context).inflate(R.layout.home_popmore_gift, null)
